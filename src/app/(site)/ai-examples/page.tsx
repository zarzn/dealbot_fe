...
const AiToolPage = () => {
  ...
  return (
    <>
      <title>AI Examples | AI Agentic Deals System</title>
      <meta name="description" content="AI Example tools for AI Agentic Deals System" />

      <Breadcrumb pageTitle="AI Examples" />
